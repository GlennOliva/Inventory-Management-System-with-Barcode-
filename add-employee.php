    ...
    <div class="grid-container">
      ...
      <main class="main-container">
        <div class="main-title">
          <p class="font-weight-bold">ADD EMPLOYEE</p>
        </div>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <div class="flex">
               ...
               <div class="inputBox">
                  ...
                  <input type="file" name="image-emp" accept="image/jpg, image/jpeg, image/png, image/webp" class="box" required>
              </div>
            ...
            <input type="submit" value="Add Employee" class="btn" name="add_emp">
         </form>
      </main>
      <!-- End Main -->
      <?php
...
if(isset($_POST['add_emp']))
{
    ...
    if(isset($_FILES['image-emp']['name']))
    {
        //get the details of the selected image
        $image_name = $_FILES['image-emp']['name'];
        ...
        if ($image_name != "") {
            ...
            $src = $_FILES['image-emp']['tmp_name'];
        
            // Destination path for the image to be uploaded
            $destination = "images/emp/" . $image_name;
    ...
    $sql = "INSERT INTO tbl_employee SET  username = '$name' , email = '$email',
    ...
    if ($result == true) {
        ...
        echo '<script>
            swal({
                title: "Success",
                text: "Employee Successfully Inserted",
                icon: "success"
            }).then(function() {
    ...
    swal({
        title: "Error",
        text: "Employee Failed to  Insert",
        icon: "error"
    }).then(function() {
        window.location = "add-employee.php";
    });
