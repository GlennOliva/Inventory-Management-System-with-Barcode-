    ...
    <div class="grid-container">
      ...
      <main class="main-container">
        <div class="main-title">
          <p class="font-weight-bold">UPDATE EMPLOYEE PASSWORD</p>
        </div>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <div class="flex">
              ...
              <input type="submit" value="Update Password" class="btn" name="updatepass_emp">
           </form>
        ...
        if(isset($_POST['updatepass_emp']))
        {
            ...
            $sql = "SELECT * FROM tbl_employee WHERE id=$id && password ='$current_passowrd'";
            ...
            if($result==true)
            {
                ...
                if($count==1)
                {
                    ...
                    {
                        //update the password
                        $sql2 = "UPDATE tbl_employee SET password ='$new_password' WHERE id=$id";
