    ...
    <div class="grid-container">
      ...
      <main class="main-container" id="admin_table">
        <div class="main-title">
          <p class="font-weight-bold">Employee Acc</p>
        </div>

        <div class="btn-add">
            <a href="add-employee.php" class="btn1"><i class="material-icons-outlined">add_circle</i> Add Employee</a>
        </div>
           <table >
            <thead>
                <tr>
            ...
            <?php
                            ...
                            <?php
                                        ...
                                        else
                                        {
                                            ...
                                            ?>
                                                ...
                                                <img src="images/emp/<?php echo $image_name?>" style="width: 70px;">
                ...
                <td>
                    <div class="btn-group">
                        <a href="update-employee-pass.php?id=<?php echo $id; ?>" class="btn1"><i class="material-icons-outlined">pin</i>Change Pass</a>
                            <a href="update-employee.php?id=<?php echo $id; ?>" class="btn"><i class="material-icons-outlined">edit</i> Update</a>
                            <form action="code.php" method="post">
                            <button type="button"  class="btn-del delete_empbtn" value="<?= $id;?>"><i class="material-icons-outlined">delete</i> Delete</button>
                            </form>
                        </div>
                </td>
            </tr>
