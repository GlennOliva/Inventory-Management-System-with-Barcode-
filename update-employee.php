...
<html lang="en">
  ...
  ?>
    <div class="grid-container">
      ...
      <?php
          ...
          if($result == True)
          {
              ...
              {
                  header('Location: employee-acc.php');
                  exit();
              }
          }
      ...
      <main class="main-container">
        <div class="main-title">
          <p class="font-weight-bold">UPDATE EMPLOYEE</p>
        </div>
              ...
              <?php
                 ...
                 if($current_image == "")
                 {
                     ...
                     swal({
                         ...
                         window.location = "employee-acc.php";
                     });
                 </script>';
                 ...
                 else
                 {
                     //image available
                     ?>
                         <img src="images/emp/<?php echo $current_image;?>" style="width: 20%;">
    ...
    <input type="submit" value="Update Employee" class="btn" name="update_emp">
    </form>
        ...
        if(isset($_POST['update_emp']))
        {
            ...
            if(isset($_FILES['image']['name']))
            {
                ...
                if($image_name!="")
                {
                    ...
                    $image_name = "Employee-Pic-".rand(0000, 9999).'.'.$ext;
            
                    // Get the source path and destination
                    $src_path = $_FILES['image']['tmp_name'];
                    $destination_path = "images/emp/".$image_name;
                    ...
                    if($current_image!="")
                    {
                        ...
                        $remove_path = "images/emp/".$current_image;
            ...
            $sql = "UPDATE tbl_employee SET username = '$username' , email = '$email' , age = '$age', address = '$address', image = '$image_name'  WHERE id = '$id'";
            ...
            exit; // Make sure to exit after performing the redirect
                ...
                echo '<script>
                    swal({
                        title: "Error",
                        text: "Employee Failed to  Update",
                        icon: "error"
                    }).then(function() {
                        window.location = "update-employee.php";
                    });
                </script>';
